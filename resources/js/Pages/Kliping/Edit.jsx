...
export default function Edit({ kliping }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        judul: kliping.judul || '',
        media: kliping.media || '',
        tanggal: kliping.tanggal || '',
        url: kliping.url || '',
        gambar_url: '',
        isi_berita: kliping.isi_berita || '',
        sentimen: kliping.sentimen || 'netral',
        status: kliping.status || 'draft',
        sentimen_confidence: kliping.sentimen_confidence || '',
        sentimen_otomatis: kliping.sentimen_otomatis || false,
        sentimen_metode: kliping.sentimen_metode || '',
        sentimen_model: kliping.sentimen_model || '',
        terkait_pimpinan: kliping.terkait_pimpinan || false,
        persentase_keterkaitan: kliping.persentase_keterkaitan || '',
        tingkat_keterkaitan: kliping.tingkat_keterkaitan || '',
        kata_kunci_keterkaitan: kliping.kata_kunci_keterkaitan || '',
        file: null,
    });
    ...
    const submit = (e) => {
        ...
        post(route('kliping.update', kliping.id));
    };
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-white">Edit Kliping Media</h2>}
        >
            <Head title="Edit Kliping" />
                            ...
                            <form onSubmit={submit} className="space-y-6" encType="multipart/form-data">
                                <div className="rounded-lg border border-blue-100 bg-blue-50 p-4">
                                    ...
                                    {data.gambar_url && (
                                        <div className="mt-3 overflow-hidden rounded-lg border border-gray-200 bg-white">
                                            ...
                                            <div className="px-3 py-2 text-xs text-gray-600">Gambar utama akan disimpan otomatis jika kliping belum memiliki file.</div>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs text-gray-500">Jika belum ada file, gambar utama dari URL akan disimpan otomatis.</p>
                                ...
                                {kliping.file_path && (
                                    <div className="rounded-md bg-gray-50 p-4 text-sm text-gray-600">
                                        File saat ini:{' '}
                                        <a href={kliping.file_url} target="_blank" rel="noopener noreferrer" className="font-semibold text-primary-light hover:underline">
                                            Lihat File
                                        </a>
                                    </div>
                                )}
